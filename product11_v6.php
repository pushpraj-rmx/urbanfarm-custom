          ...
          <div class="product-single__media" data-media-type="list-image">
            <div class="product-single__image d-flex flex-column gap-2">
              <div class="product-single__image-item">
                <img loading="lazy" class="h-auto" src="./images/products/product_0.jpg" width="700" height="700" alt="" />
              </div>
              <div class="product-single__image-item">
                <img loading="lazy" class="h-auto" src="./images/products/product_0-1.jpg" width="700" height="700" alt="" />
              </div>
              <div class="product-single__image-item">
                <img loading="lazy" class="h-auto" src="./images/products/product_0-2.jpg" width="700" height="700" alt="" />
              </div>
              <div class="product-single__image-item">
                <img loading="lazy" class="h-auto" src="./images/products/product_0-3.jpg" width="700" height="700" alt="" />
              </div>
            </div>
          </div>
        </div>
