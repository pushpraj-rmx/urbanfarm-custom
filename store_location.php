...
<body>
  ...
  <main>
    ...
    <section class="store-location container">
      ...
      <div class="row">
        <div class="col-lg-4">
          <form action="https://uomo-html.flexkitux.com/Demo2/search.php" method="GET">
            <div class="store-location__search">
              <input class="store-location__search-input" type="text" name="search-keyword" placeholder="Enter your country or city" />
              <button class="btn-icon store-location__search-btn" type="submit">
                <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_search" />
                </svg>
              </button>
            ...
            <div class="store-location__search-result">
              <div class="store-location__search-result__item">
                ...
                <p>
                  ...
                  States<br />+1 246-345-0695<br />10 am - 10 pm EST, 7 days a
                  week
                </p>
                <a id="store_selector_1" href="#map">See on the map</a>
              </div>
              <div class="store-location__search-result__item">
                <h5>Store in Istanbul</h5>
                <p>
                  1418 River Drive, Suite 35 Cottonhall, CA 9622<br />United
                  States<br />+1 246-345-0695<br />10 am - 10 pm EST, 7 days a
                  week
                </p>
                <a id="store_selector_2" href="#map">See on the map</a>
              </div>
              <div class="store-location__search-result__item">
                <h5>Store in New York</h5>
                <p>
                  1418 River Drive, Suite 35 Cottonhall, CA 9622<br />United
                  States<br />+1 246-345-0695<br />10 am - 10 pm EST, 7 days a
                  week
                </p>
                <a id="store_selector_3" href="#map">See on the map</a>
              </div>
            </div>
          </form>
        </div>
