          ...
          <div class="shop-banner__content container position-absolute start-50 top-50 translate-middle">
            ...
            <ul class="d-flex flex-wrap justify-content-center list-unstyled text-uppercase h6" aria-label="Collections List">
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s text-white menu-link_active">StayHome</a>
              </li>
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s text-white">New In</a>
              </li>
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s text-white">Jackets</a>
              </li>
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s text-white">Hoodies</a>
              </li>
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s text-white">Men</a>
              </li>
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s text-white">Women</a>
              </li>
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s text-white">Trousers</a>
              </li>
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s text-white">Accessories</a>
              </li>
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s text-white">Shoes</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_5.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_5-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_7.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_7-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_8.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_8-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_9.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_9-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_10.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_10-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_11.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_11-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_12.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_12-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_13.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_13-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_14.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_14-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_15.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                  <div class="swiper-slide">
                    <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_15-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  </div>
                </div>
                <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
