  ...
  <body>
    ...
    <main>
      <section>
        <div style="border-color: #eeeeee">
          <div class="shop-banner position-relative">
            <div
              class="background-img background-img_overlay"
              style="background-color: #eeeeee"
            >
              <img
                loading="lazy"
                src="./images/shop/shop_banner6.jpg"
                width="1903"
                height="420"
                alt="Pattern"
            ...
            >
              <h2
                class="h1 text-uppercase text-white text-center fw-bold mb-3 mb-xl-4 mb-xl-5"
              >
                Jackets & Coats
              </h2>
              <ul
                class="d-flex flex-wrap justify-content-center list-unstyled text-uppercase h6"
                aria-label="Collections List"
              >
                <li class="me-3 me-xl-4 pe-1">
                  <a
                    href="#"
                    class="menu-link menu-link_us-s text-white menu-link_active"
                    >StayHome</a
                  >
                </li>
                <li class="me-3 me-xl-4 pe-1">
                  <a href="#" class="menu-link menu-link_us-s text-white"
                    >New In</a
                  >
                </li>
                <li class="me-3 me-xl-4 pe-1">
      ...
      <section class="shop-main container">
        ...
        <div
          class="products-grid row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5"
          id="products-grid"
        >
        ...
        <div
          class="progress progress_uomo mb-3 ms-auto me-auto"
          style="width: 300px"
        >
          <div
            class="progress-bar"
        ...
        <div class="text-center">
          <a class="btn-link btn-link_lg text-uppercase fw-medium" href="#"
            >Show More</a
          >
        </div>
      </section>
