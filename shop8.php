  ...
  <body>
    ...
    <main>
        ...
        <div class="shop-categories position-relative">
          ...
          >
            <a href="#" class="shop-categories__item mb-3">
              <img
                loading="lazy"
                src="./images/shop/category-item1.png"
                width="120"
                height="120"
                alt="Women Tops"
                class="shop-categories__item-img rounded-circle"
              />
            ...
            <a href="#" class="shop-categories__item mb-3">
              <img
                loading="lazy"
                src="./images/shop/category-item2.png"
                width="120"
                height="120"
                alt="Women Pants"
                class="shop-categories__item-img rounded-circle"
            ...
            <a href="#" class="shop-categories__item mb-3">
              <img
                loading="lazy"
                src="./images/shop/category-item3.png"
                width="120"
                height="120"
                alt="Women Clothes"
                class="shop-categories__item-img rounded-circle"
            ...
            <a href="#" class="shop-categories__item mb-3">
              <img
                loading="lazy"
                src="./images/shop/category-item4.png"
                width="120"
                height="120"
                alt="Men Jeans"
                class="shop-categories__item-img rounded-circle"
            ...
            <a href="#" class="shop-categories__item mb-3">
              <img
                loading="lazy"
                src="./images/shop/category-item5.png"
                width="120"
                height="120"
                alt="Men Shirts"
                class="shop-categories__item-img rounded-circle"
            ...
            <a href="#" class="shop-categories__item mb-3">
              <img
                loading="lazy"
                src="./images/shop/category-item6.png"
                width="120"
                height="120"
                alt="Men Shoes"
                class="shop-categories__item-img rounded-circle"
            ...
            <a href="#" class="shop-categories__item mb-3">
              <img
                loading="lazy"
                src="./images/shop/category-item7.png"
                width="120"
                height="120"
                alt="Women Dresses"
                class="shop-categories__item-img rounded-circle"
            ...
            <a href="#" class="shop-categories__item mb-3">
              <img
                loading="lazy"
                src="./images/shop/category-item8.png"
                width="120"
                height="120"
                alt="Kids Tops"
                class="shop-categories__item-img rounded-circle"
      ...
      <section class="shop-main container">
        ...
        <div
          class="products-grid row row-cols-2 row-cols-md-3 row-cols-lg-4"
          id="products-grid"
        >
