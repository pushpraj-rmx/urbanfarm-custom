  ...
  <main>
    <section class="full-width_padding" style="background-color: #faf9f8">
      <div class="shop-categories position-relative">
        <h2 class="h3 pb-3 mb-4 fw-normal text-uppercase text-center">
          You Might Like
        </h2>
        ...
        <div class="shop-categories__list d-flex align-items-center flex-wrap justify-content-center">
          <a href="#" class="shop-categories__item mb-3">
            <img loading="lazy" src="./images/shop/category-item1.png" width="120" height="120" alt="Women Tops" class="shop-categories__item-img rounded-circle" />
            <h6 class="pt-1 mt-3 mt-xl-4 mb-0 text-center">
              Women<br />Tops
            </h6>
          </a>

          <a href="#" class="shop-categories__item mb-3">
            <img loading="lazy" src="./images/shop/category-item2.png" width="120" height="120" alt="Women Pants" class="shop-categories__item-img rounded-circle" />
            <h6 class="pt-1 mt-3 mt-xl-4 mb-0 text-center">
              Women<br />Pants
            </h6>
          </a>
          ...
          <a href="#" class="shop-categories__item mb-3">
            <img loading="lazy" src="./images/shop/category-item3.png" width="120" height="120" alt="Women Clothes" class="shop-categories__item-img rounded-circle" />
            <h6 class="pt-1 mt-3 mt-xl-4 mb-0 text-center">
              Women<br />Clothes
            </h6>
          </a>
          ...
          <a href="#" class="shop-categories__item mb-3">
            <img loading="lazy" src="./images/shop/category-item4.png" width="120" height="120" alt="Men Jeans" class="shop-categories__item-img rounded-circle" />
            <h6 class="pt-1 mt-3 mt-xl-4 mb-0 text-center">Men<br />Jeans</h6>
          </a>

          <a href="#" class="shop-categories__item mb-3">
            <img loading="lazy" src="./images/shop/category-item5.png" width="120" height="120" alt="Men Shirts" class="shop-categories__item-img rounded-circle" />
            <h6 class="pt-1 mt-3 mt-xl-4 mb-0 text-center">
              Men<br />Shirts
            </h6>
          </a>
          ...
          <a href="#" class="shop-categories__item mb-3">
            <img loading="lazy" src="./images/shop/category-item6.png" width="120" height="120" alt="Men Shoes" class="shop-categories__item-img rounded-circle" />
            <h6 class="pt-1 mt-3 mt-xl-4 mb-0 text-center">Men<br />Shoes</h6>
          </a>

          <a href="#" class="shop-categories__item mb-3">
            <img loading="lazy" src="./images/shop/category-item7.png" width="120" height="120" alt="Women Dresses" class="shop-categories__item-img rounded-circle" />
            <h6 class="pt-1 mt-3 mt-xl-4 mb-0 text-center">
              Women<br />Dresses
            </h6>
          </a>
          ...
          <a href="#" class="shop-categories__item mb-3">
            <img loading="lazy" src="./images/shop/category-item8.png" width="120" height="120" alt="Kids Tops" class="shop-categories__item-img rounded-circle" />
