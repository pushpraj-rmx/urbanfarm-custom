        ...
        <div class="full-width_border border-2" style="border-color: #eee">
          <div class="shop-banner position-relative">
            <div class="background-img" style="background-color: #eee">
              <img
                loading="lazy"
                src="./images/shop/shop_banner8.png"
                width="1759"
                height="420"
                alt="Pattern"
            ...
            >
              <h2
                class="h1 stroke-text smooth-16 text-uppercase fw-bold mb-3 mb-xl-4"
              >
                Shop
              </h2>
      ...
      <section class="shop-main container">
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          >
            ...
            <div
              class="shop-asc__seprator mx-3 bg-light d-none d-lg-block order-md-1"
            ></div>

            <div
              class="shop-filter d-flex align-items-center order-0 order-md-3"
            >
              <button
        ...
        <div class="products-grid">
            ...
            <div class="product-card-wrapper">
              <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                ...
                <div class="pc__info position-relative">
                  ...
                  <div
                    class="product-card__review d-sm-flex align-items-center"
                  >
                    ...
                    <span
                      class="reviews-note text-lowercase text-secondary ms-sm-1"
                      >8k+ reviews</span
                    >
                  </div>
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-27-1.jpg"
                            width="330"
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img"
                      ...
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-27-2.jpg"
                            width="330"
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img"
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-28-1.jpg"
                            width="330"
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img"
                      ...
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-28-2.jpg"
                            width="330"
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img"
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-29-1.jpg"
                            width="330"
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img"
                      ...
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-29-2.jpg"
                            width="330"
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img"
          ...
          >
            <div class="product-card-wrapper">
              <div
                class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5"
              >
                <div class="pc__img-wrapper">
                  <div
                    class="swiper-container background-img js-swiper-slider"
                      ...
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            ...
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img object-position-top"
                        /></a>
                      </div>
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
            ...
            <div class="product-card-wrapper">
              <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                <div class="pc__img-wrapper">
                    ...
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-22-1.jpg"
                            width="330"
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img"
                      ...
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-22-2.jpg"
                            width="330"
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img"
                  ...
                  <div
                    class="anim_appear-bottom position-absolute w-100 text-center mb-3"
                  >
                    <button
            ...
            <div class="product-card-wrapper">
              <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                <div class="pc__img-wrapper">
                  ...
                  <div
                    class="anim_appear-right position-absolute top-0 mt-2 me-2"
                  >
                    <button
            ...
            <div class="product-card-wrapper">
              <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                ...
                <div class="pc__info position-relative">
                  ...
                  <h6 class="pc__title">
                    <a href="product1_simple.php"
                      >Shirt In Bontanical Cheetah Print</a
                    >
                  </h6>
                  <div class="product-card__price d-flex">
                    <span class="money price price-old">$129</span>
          ...
          >
            <div class="product-card-wrapper overflow-hidden">
              <div
                class="product-card product-card_style6 hover-container mb-3 mb-md-4 mb-xxl-5"
              >
                <div class="pc__img-wrapper">
                  <div
                    class="swiper-container background-img js-swiper-slider"
                ...
                <div class="pc__info position-relative bg-body">
                  <div class="position-relative">
                    ...
                    <div
                      class="hover__content d-flex align-items-center top-0 end-0 bg-body w-auto"
                    >
                      <a
                        href="#"
                        class="swatch-color pc__swatch-color"
              ...
              <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-30-1.jpg"
                            width="330"
                            height="400"
                            alt="Wildhorse 6"
                            class="pc__img"
                ...
                <div class="pc__info position-relative">
                  ...
                  >
                    ...
                    <button
                      class="btn-link btn-link_lg text-uppercase fw-medium js-quick-view"
                      data-bs-toggle="modal"
                      data-bs-target="#quickView"
                      title="Quick view"
                    >
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-31-1.jpg"
                            width="330"
                            height="400"
                            alt="Gray Vintage Chair"
                            class="pc__img"
                        /></a>
                      </div>
                      <div class="swiper-slide">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-32-1.jpg"
                            width="330"
                            height="400"
                            alt="Indy Icon Clash"
                            class="pc__img"
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <a href="product1_simple.php"
                          ><img
                            loading="lazy"
                            src="./images/products/product-33-1.jpg"
                            width="330"
                            height="400"
                            alt="Cropped Faux leather Jacket"
                            class="pc__img"
          ...
          >
            <div class="product-card-wrapper">
              <div
                class="product-card product-card_style8 mb-3 mb-md-4 mb-xxl-5"
              >
                <div class="pc__img-wrapper pc__img-wrapper_wide2">
                  <a href="product1_simple.php"
                    ><img
                      loading="lazy"
                      src="./images/products/product-37-1.jpg"
                      width="328"
                      height="298"
                ...
                <div class="pc__info position-relative">
                  ...
                  <h6 class="pc__title">
                    <a href="product1_simple.php"
                      >Toshiba TF-43A810U21 43-inch 4K UHD TV - Fire TV
                      Edition</a
                    >
                  </h6>
                  <div
                  ...
                  >
                    ...
                    <button
                      class="pc__btn-wl bg-transparent border-0 ms-3 ms-xxl-auto js-add-wishlist"
                      title="Add To Wishlist"
                    >
                      <svg
                        width="16"
              ...
              >
                <div class="pc__img-wrapper pc__img-wrapper_wide2">
                  <a href="product1_simple.php"
                    ><img
                      loading="lazy"
                      src="./images/products/product-35-1.jpg"
                      width="328"
                      height="298"
                ...
                <div class="pc__info position-relative">
                  ...
                  <h6 class="pc__title">
                    <a href="product1_simple.php"
                      >Wyze Cam 1080p HD Indoor Wireless Smart Home Camera with
                      Night Vision...</a
                    >
                  </h6>
                  <div
              ...
              >
                <div class="pc__img-wrapper pc__img-wrapper_wide2">
                  <a href="product1_simple.php"
                    ><img
                      loading="lazy"
                      src="./images/products/product-36-1.jpg"
                      width="328"
                      height="298"
                ...
                <div class="pc__info position-relative">
                  ...
                  <h6 class="pc__title">
                    <a href="product1_simple.php"
                      >NUBWO Gaming headsets PS4 N7 Stereo Xbox one Headset
                      Gaming...</a
                    >
                  </h6>
                  <div
          ...
          <div
            class="row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xxl-5"
            id="products-grid-9"
          >
            <div class="product-card-wrapper">
              <div
                class="product-card product-card_style9 border rounded-3 mb-3 mb-md-4 mb-xxl-5"
              >
                <div class="position-relative pb-3">
                  <div class="pc__img-wrapper pc__img-wrapper_wide3">
                    <a href="product1_simple.php"
                      ><img
                        loading="lazy"
                        src="./images/products/product-38-1.jpg"
                        width="256"
                        height="201"
                        alt="Cropped Faux leather Jacket"
                        class="pc__img"
                  ...
                  <div
                    class="anim_appear-bottom position-absolute w-100 text-center"
                  >
                    <button
                ...
                <div class="position-relative pb-3">
                  <div class="pc__img-wrapper pc__img-wrapper_wide3">
                    <a href="product1_simple.php"
                      ><img
                        loading="lazy"
                        src="./images/products/product-39-1.jpg"
                        width="256"
                        height="201"
                        alt="Cropped Faux leather Jacket"
                        class="pc__img"
                ...
                <div class="position-relative pb-3">
                  <div class="pc__img-wrapper pc__img-wrapper_wide3">
                    <a href="product1_simple.php"
                      ><img
                        loading="lazy"
                        src="./images/products/product-40-1.jpg"
                        width="256"
                        height="201"
                        alt="Cropped Faux leather Jacket"
                        class="pc__img"
                ...
                <div class="position-relative pb-3">
                  <div class="pc__img-wrapper pc__img-wrapper_wide3">
                    <a href="product1_simple.php"
                      ><img
                        loading="lazy"
                        src="./images/products/product-41-1.jpg"
                        width="256"
                        height="201"
                        alt="Cropped Faux leather Jacket"
                        class="pc__img"
                ...
                <div class="position-relative pb-3">
                  <div class="pc__img-wrapper pc__img-wrapper_wide3">
                    <a href="product1_simple.php"
                      ><img
                        loading="lazy"
                        src="./images/products/product-42-1.jpg"
                        width="256"
                        height="201"
                        alt="Cropped Faux leather Jacket"
                        class="pc__img"
          ...
          >
            <div class="product-card-wrapper">
              <div
                class="product-card product-card_style10 mb-3 mb-md-4 mb-xxl-5"
              >
                <div class="position-relative pb-3">
                  <div class="pc__img-wrapper pc__img-wrapper_wide3">
                    <a href="product1_simple.php"
                      ><img
                        loading="lazy"
                        src="./images/products/product-43.png"
                        width="256"
                        height="201"
                        alt="Cropped Faux leather Jacket"
                        class="pc__img"
                ...
                <div class="position-relative pb-3">
                  <div class="pc__img-wrapper pc__img-wrapper_wide3">
                    <a href="product1_simple.php"
                      ><img
                        loading="lazy"
                        src="./images/products/product-44.png"
                        width="256"
                        height="201"
                        alt="Cropped Faux leather Jacket"
                        class="pc__img"
                ...
                <div class="position-relative pb-3">
                  <div class="pc__img-wrapper pc__img-wrapper_wide3">
                    <a href="product1_simple.php"
                      ><img
                        loading="lazy"
                        src="./images/products/product-45.png"
                        width="256"
                        height="201"
                        alt="Cropped Faux leather Jacket"
                        class="pc__img"
                ...
                <div class="position-relative pb-3">
                  <div class="pc__img-wrapper pc__img-wrapper_wide3">
                    <a href="product1_simple.php"
                      ><img
                        loading="lazy"
                        src="./images/products/product-46.png"
                        width="256"
                        height="201"
                        alt="Cropped Faux leather Jacket"
                        class="pc__img"
