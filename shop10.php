...
<body>
  ...
  <div class="header-mobile header_sticky">
    ...
    <nav class="header-mobile__navigation navigation d-flex flex-column w-100 position-absolute top-100 bg-body overflow-auto">
      <div class="container">
        <form action="https://uomo-html.flexkitux.com/Demo2/search.php" method="GET" class="search-field position-relative mt-4 mb-3">
      ...
      <div class="container">
        <div class="overflow-hidden">
          <ul class="navigation__list list-unstyled position-relative">
              ...
              <div class="sub-menu position-absolute top-0 start-100 w-100 d-none">
                ...
                <ul class="list-unstyled">
                  <li class="sub-menu__item">
                    <a href="../Demo1/index.php" class="menu-link menu-link_us-s">Home 1</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="index.php" class="menu-link menu-link_us-s">Home 2</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo3/index.php" class="menu-link menu-link_us-s">Home 3</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo4/index.php" class="menu-link menu-link_us-s">Home 4</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo5/index.php" class="menu-link menu-link_us-s">Home 5</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo6/index.php" class="menu-link menu-link_us-s">Home 6</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo7/index.php" class="menu-link menu-link_us-s">Home 7</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo8/index.php" class="menu-link menu-link_us-s">Home 8</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo9/index.php" class="menu-link menu-link_us-s">Home 9</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo10/index.php" class="menu-link menu-link_us-s">Home 10</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo11/index.php" class="menu-link menu-link_us-s">Home 11</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo12/index.php" class="menu-link menu-link_us-s">Home 12</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo13/index.php" class="menu-link menu-link_us-s">Home 13</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo14/index.php" class="menu-link menu-link_us-s">Home 14</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo15/index.php" class="menu-link menu-link_us-s">Home 15</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="../Demo16/index.php" class="menu-link menu-link_us-s">Home 16</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="navigation__item">
              <a href="#" class="navigation__link js-nav-right d-flex align-items-center">Shop<svg class="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_next_sm" />
                </svg></a>
              <div class="sub-menu position-absolute top-0 start-100 w-100 d-none">
                <a href="#" class="navigation__link js-nav-left d-flex align-items-center border-bottom mb-3"><svg class="me-2" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_sm" />
                  </svg>Shop</a>
                <div class="sub-menu__wrapper">
                  <a href="#" class="navigation__link js-nav-right d-flex align-items-center">Shop List<svg class="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_next_sm" />
                    </svg></a>
                  <div class="sub-menu__wrapper position-absolute top-0 start-100 w-100 d-none">
                    ...
                    <ul class="sub-menu__list list-unstyled">
                      ...
                      <li class="sub-menu__item">
                        <a href="shop11.php" class="menu-link menu-link_us-s">Horizontal Scroll</a>
                      </li>
                    </ul>
                  </div>

                  <a href="#" class="navigation__link js-nav-right d-flex align-items-center">Shop Detail<svg class="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_next_sm" />
                    </svg></a>
                  <div class="sub-menu__wrapper position-absolute top-0 start-100 w-100 d-none">
                    <a href="#" class="navigation__link js-nav-left d-flex align-items-center border-bottom mb-2"><svg class="me-2" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sub-menu__list list-unstyled">
                      ...
                      <li class="sub-menu__item">
                        <a href="product7_v2.php" class="menu-link menu-link_us-s">Shop Detail V2</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product8_v3.php" class="menu-link menu-link_us-s">Shop Detail V3</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product9_v4.php" class="menu-link menu-link_us-s">Shop Detail V4</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product10_v5.php" class="menu-link menu-link_us-s">Shop Detail V5</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product11_v6.php" class="menu-link menu-link_us-s">Shop Detail V6</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product12_v7.php" class="menu-link menu-link_us-s">Shop Detail V7</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product13_v8.php" class="menu-link menu-link_us-s">Shop Detail V8</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product14_v9.php" class="menu-link menu-link_us-s">Shop Detail V9</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product15_v10.php" class="menu-link menu-link_us-s">Shop Detail V10</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product16_v11.php" class="menu-link menu-link_us-s">Shop Detail V11</a>
                      </li>
                    </ul>
                  </div>

                  <a href="#" class="navigation__link js-nav-right d-flex align-items-center">Other Pages<svg class="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_next_sm" />
                    </svg></a>
                  <div class="sub-menu__wrapper position-absolute top-0 start-100 w-100 d-none">
                    <a href="#" class="navigation__link js-nav-left d-flex align-items-center border-bottom mb-2"><svg class="me-2" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sub-menu__list list-unstyled">
                      <li class="sub-menu__item">
                        <a href="shop12.php" class="menu-link menu-link_us-s">Collection Grid</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product1_simple.php" class="menu-link menu-link_us-s">Simple Product</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product2_variable.php" class="menu-link menu-link_us-s">Variable Product</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product3_external.php" class="menu-link menu-link_us-s">External Product</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product4_grouped.php" class="menu-link menu-link_us-s">Grouped Product</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product5_onsale.php" class="menu-link menu-link_us-s">On Sale</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="product6_outofstock.php" class="menu-link menu-link_us-s">Out of Stock</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="shop_cart.php" class="menu-link menu-link_us-s">Shopping Cart</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="shop_checkout.php" class="menu-link menu-link_us-s">Checkout</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="shop_order_complete.php" class="menu-link menu-link_us-s">Order Complete</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="shop_order_tracking.php" class="menu-link menu-link_us-s">Order Tracking</a>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <li class="navigation__item">
              <a href="#" class="navigation__link js-nav-right d-flex align-items-center">Blog<svg class="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_next_sm" />
                </svg></a>
              <div class="sub-menu position-absolute top-0 start-100 w-100 d-none">
                <a href="#" class="navigation__link js-nav-left d-flex align-items-center border-bottom mb-2"><svg class="me-2" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="list-unstyled">
                  <li class="sub-menu__item">
                    <a href="blog_list1.php" class="menu-link menu-link_us-s">Blog V1</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="blog_list2.php" class="menu-link menu-link_us-s">Blog V2</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="blog_list3.php" class="menu-link menu-link_us-s">Blog V3</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="blog_single.php" class="menu-link menu-link_us-s">Blog Detail</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="navigation__item">
              <a href="#" class="navigation__link js-nav-right d-flex align-items-center">Pages<svg class="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_next_sm" />
                </svg></a>
              <div class="sub-menu position-absolute top-0 start-100 w-100 d-none">
                <a href="#" class="navigation__link js-nav-left d-flex align-items-center border-bottom mb-2"><svg class="me-2" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="list-unstyled">
                  <li class="sub-menu__item">
                    <a href="account_dashboard.php" class="menu-link menu-link_us-s">My Account</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="login_register.php" class="menu-link menu-link_us-s">Login / Register</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="store_location.php" class="menu-link menu-link_us-s">Store Locator</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="lookbook.php" class="menu-link menu-link_us-s">Lookbook</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="faq.php" class="menu-link menu-link_us-s">Faq</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="terms.php" class="menu-link menu-link_us-s">Terms</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="404.php" class="menu-link menu-link_us-s">404 Error</a>
                  </li>
                  <li class="sub-menu__item">
                    <a href="coming_soon.php" class="menu-link menu-link_us-s">Coming Soon</a>
                  </li>
                </ul>
              </div>
            </li>
        ...
        <div class="header-tools d-flex align-items-center">
          <div class="header-tools__item hover-container">
            ...
            <div class="search-popup js-hidden-content">
              <form action="https://uomo-html.flexkitux.com/Demo2/search_result.php" method="GET" class="search-field container">
                ...
                <div class="search-popup__results">
                  <div class="sub-menu search-suggestion">
                    ...
                    <ul class="sub-menu__list list-unstyled">
                      <li class="sub-menu__item">
                        <a href="shop2.php" class="menu-link menu-link_us-s">New Arrivals</a>
                      </li>
                      <li class="sub-menu__item">
                      ...
                      <li class="sub-menu__item">
                        <a href="#" class="menu-link menu-link_us-s">Footwear</a>
                      </li>
                      <li class="sub-menu__item">
                        <a href="#" class="menu-link menu-link_us-s">Sweatshirt</a>
                      </li>
                    </ul>
                  </div>
      ...
      <div class="full-width_border border-2" style="border-color: #eee">
        <div class="shop-banner position-relative">
          <div class="background-img" style="background-color: #eee">
            <img loading="lazy" src="./images/shop/shop_banner8.png" width="1759" height="420" alt="Pattern" class="slideshow-bg__img object-fit-cover" />
          </div>

          <div class="shop-banner__content container position-absolute start-50 top-50 translate-middle">
            <h2 class="h1 stroke-text smooth-16 text-uppercase fw-bold mb-3 mb-xl-4">
              Shop
            </h2>
            <ul class="d-flex flex-wrap list-unstyled text-uppercase h6">
              <li class="me-3 me-xl-4 pe-1">
                <a href="#" class="menu-link menu-link_us-s menu-link_active">StayHome</a>
              </li>
              <li class="me-3 me-xl-4 pe-1">
      ...
      <div class="d-flex justify-content-between mb-4 pb-md-2">
        ...
        <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
          ...
          <div class="col-size align-items-center order-1 d-none d-lg-flex">
            ...
            <button class="btn-link fw-medium me-2 js-cols-size" data-target="products-grid-1" data-cols="2">
              2
            </button>
            <button class="btn-link fw-medium me-2 js-cols-size" data-target="products-grid-1" data-cols="3">
              3
            </button>
            <button class="btn-link fw-medium js-cols-size" data-target="products-grid-1" data-cols="4">
              4
            </button>
          </div>
      ...
      <div class="products-grid">
          ...
          <div class="product-card-wrapper">
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title">
                  <a href="product1_simple.php">Cropped Faux Leather Jacket</a>
                </h6>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-26-1.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-26-2.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
                ...
                <div class="anim_appear-bottom position-absolute bottom-0 start-0 w-100 d-none d-sm-flex align-items-center">
                  <button class="btn btn-primary flex-grow-1 fs-base ps-3 ps-xxl-4 pe-0 border-0 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                    Add To Cart
                  </button>
                  <button class="btn btn-primary flex-grow-1 fs-base ps-0 pe-3 pe-xxl-4 border-0 text-uppercase fw-medium js-quick-view" data-bs-toggle="modal" data-bs-target="#quickView" title="Quick view">
                    Quick View
                  </button>
                </div>
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title">
                  <a href="product1_simple.php">Colorful Jacket</a>
                </h6>
                <div class="product-card__price d-flex">
                  <span class="money price">$29</span>
                </div>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-27-1.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-27-2.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
              ...
              <div class="pc__info position-relative">
                <p class="pc__category text-beige">Dresses</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Shirt In Botanical Cheetah Print</a>
                </h6>
                <div class="product-card__price d-flex">
                  <span class="money price">$62</span>
                </div>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-28-1.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-28-2.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
              ...
              <div class="pc__info position-relative">
                <p class="pc__category text-beige">Dresses</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Cotton Jersey T-Shirt</a>
                </h6>
                <div class="product-card__price d-flex">
                  <span class="money price">$17</span>
                </div>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-29-1.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-29-2.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
              ...
              <div class="pc__info position-relative">
                <p class="pc__category text-beige">Dresses</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Zessi Dresses</a>
                </h6>
                <div class="product-card__price d-flex">
                  <span class="money price price-old">$129</span>
                  <span class="money price price-sale">$99</span>
            ...
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_9.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" /></a>
                    </div>
                    <div class="swiper-slide">
              ...
              <div class="pc__info position-relative">
                ...
                <div class="anim_appear-bottom position-absolute bottom-0 start-0 d-none d-sm-flex align-items-center bg-body">
                  <button class="btn-link btn-link_lg me-4 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                    Add To Cart
                  </button>
            ...
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_10.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" /></a>
                    </div>
                    <div class="swiper-slide">
            ...
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_11.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" /></a>
                    </div>
                    <div class="swiper-slide">
            ...
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_12.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" /></a>
                    </div>
                    <div class="swiper-slide">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_13.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-22-1.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-22-2.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_14.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_14-1.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_15.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" /></a>
                    </div>
                    <div class="swiper-slide">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_16.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" /></a>
                    </div>
                    <div class="swiper-slide">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_1-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
                ...
                <button class="pc__atc btn btn-lg anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                  Add To Cart
                </button>
                <div class="anim_appear-right position-absolute top-0 mt-2 me-2">
                  <button class="btn btn-round-sm btn-hover-red d-block border-0 text-uppercase mb-2 js-quick-view" data-bs-toggle="modal" data-bs-target="#quickView" title="Quick view">
                    <svg class="d-inline-block" width="14" height="14" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_view" />
                    </svg>
                  </button>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_2.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_2-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_3.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_3-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_4.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_4-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_6.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_6-1.jpg" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">Dresses</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Shirt In Bontanical Cheetah Print</a>
                </h6>
                <div class="product-card__price d-flex">
                  <span class="money price price-old">$129</span>
                  <span class="money price price-sale">$99</span>
            ...
            <div class="product-card product-card_style6 hover-container mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_13.jpg" width="330" height="400" alt="Colorful Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-22-1.jpg" width="330" height="400" alt="Colorful Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-22-2.jpg" width="330" height="400" alt="Colorful Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
              ...
              <div class="pc__info position-relative bg-body">
                <div class="position-relative">
                  ...
                  <div class="d-none d-flex align-items-center hover__content position-relative mt-3 mt-sm-0">
                    <button class="btn-link btn-link_lg me-auto me-xxl-4 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                      Add To Cart
                    </button>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-30-1.jpg" width="330" height="400" alt="Wildhorse 6" class="pc__img" /></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title mb-2">
                  <a href="product1_simple.php">Wildhorse 6</a>
                </h6>
                <div class="product-card__price d-flex mb-1">
                  <span class="money price">$29</span>
                </div>
                ...
                <div class="anim_appear-bottom position-absolute bottom-0 start-0 d-flex align-items-center bg-body">
                  <button class="btn-link btn-link_lg me-3 me-sm-4 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                    Add To Cart
                  </button>
                  <button class="btn-link btn-link_lg text-uppercase fw-medium js-quick-view" data-bs-toggle="modal" data-bs-target="#quickView" title="Quick view">
                    ...
                    <span class="d-block d-xl-none"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_view" />
                      </svg></span>
                  </button>
                </div>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-31-1.jpg" width="330" height="400" alt="Gray Vintage Chair" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_6-1.jpg" width="330" height="400" alt="Gray Vintage Chair" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title mb-2">
                  <a href="product1_simple.php">Gray Vintage Chair</a>
                </h6>
                <div class="product-card__price d-flex mb-1">
                  <span class="money price">$62</span>
                </div>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-32-1.jpg" width="330" height="400" alt="Indy Icon Clash" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_7-1.jpg" width="330" height="400" alt="Indy Icon Clash" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title mb-2">
                  <a href="product1_simple.php">Indy Icon Clash</a>
                </h6>
                <div class="product-card__price d-flex mb-1">
                  <span class="money price price-old">$129</span>
                  <span class="money price price-sale">$99</span>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-33-1.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4" id="products-grid-8">
          <div class="product-card-wrapper">
            <div class="product-card product-card_style8 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper pc__img-wrapper_wide2">
                <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-37-1.jpg" width="328" height="298" alt="Toshiba TF-43A810U21 43-inch 4K UHD TV - Fire TV Edition" class="pc__img" /></a>
              </div>

              <div class="pc__info position-relative">
                <p class="pc__category">Television & Video</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Toshiba TF-43A810U21 43-inch 4K UHD TV - Fire TV
                    Edition</a>
                </h6>
                <div class="product-card__review d-sm-flex align-items-center">
                  <div class="reviews-group d-flex">
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style8 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper pc__img-wrapper_wide2">
                <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-35-1.jpg" width="328" height="298" alt="Wyze Cam 1080p HD Indoor Wireless Smart Home Camera with Night Vision..." class="pc__img" /></a>
              </div>

              <div class="pc__info position-relative">
                <p class="pc__category">Camera & Photo</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Wyze Cam 1080p HD Indoor Wireless Smart Home Camera with
                    Night Vision...</a>
                </h6>
                <div class="product-card__review d-sm-flex align-items-center">
                  <div class="reviews-group d-flex">
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style8 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper pc__img-wrapper_wide2">
                <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-36-1.jpg" width="328" height="298" alt="NUBWO Gaming headsets PS4 N7 Stereo Xbox one Headset Gaming" class="pc__img" /></a>
              </div>

              <div class="pc__info position-relative">
                <p class="pc__category">Audio</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">NUBWO Gaming headsets PS4 N7 Stereo Xbox one Headset
                    Gaming...</a>
                </h6>
                <div class="product-card__review d-sm-flex align-items-center">
                  <div class="reviews-group d-flex">
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style8 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper pc__img-wrapper_wide2">
                <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-37-1.jpg" width="328" height="298" alt="Echo Dot (3rd Gen) - Smart speaker with Alexa - Charcoal" class="pc__img" /></a>
              </div>

              <div class="pc__info position-relative">
                <p class="pc__category">Bluetooth Speakers</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Echo Dot (3rd Gen) - Smart speaker with Alexa -
                    Charcoal</a>
                </h6>
                <div class="product-card__price d-flex">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xxl-5" id="products-grid-9">
            ...
            <div class="product-card product-card_style9 border rounded-3 mb-3 mb-md-4 mb-xxl-5">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-38-1.jpg" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                </div>
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title">
                  <a href="product1_simple.php">Organic Bartlett Pear</a>
                </h6>
                <div class="product-card__review d-sm-flex align-items-center">
                  <div class="reviews-group d-flex">
                    <svg class="review-star" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style9 border rounded-3 mb-3 mb-md-4 mb-xxl-5">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-39-1.jpg" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                </div>
                <div class="anim_appear-bottom position-absolute w-100 text-center">
                  <button class="btn btn-round btn-hover-red border-0 text-uppercase me-2 js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                    <svg class="d-inline-block" width="14" height="14" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">Fruits</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Organic Strawberries, 1 lb</a>
                </h6>
                <div class="product-card__review d-sm-flex align-items-center">
                  <div class="reviews-group d-flex">
                    <svg class="review-star" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style9 border rounded-3 mb-3 mb-md-4 mb-xxl-5">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-40-1.jpg" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                </div>
                <div class="anim_appear-bottom position-absolute w-100 text-center">
                  <button class="btn btn-round btn-hover-red border-0 text-uppercase me-2 js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                    <svg class="d-inline-block" width="14" height="14" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">Fruits</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Blueberry Organic, 6 Ounce</a>
                </h6>
                <div class="product-card__review d-sm-flex align-items-center">
                  <div class="reviews-group d-flex">
                    <svg class="review-star" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style9 border rounded-3 mb-3 mb-md-4 mb-xxl-5">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-41-1.jpg" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                </div>
                <div class="anim_appear-bottom position-absolute w-100 text-center">
                  <button class="btn btn-round btn-hover-red border-0 text-uppercase me-2 js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                    <svg class="d-inline-block" width="14" height="14" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">Fruits</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Kiwi Organic, 1 Each</a>
                </h6>
                <div class="product-card__review d-sm-flex align-items-center">
                  <div class="reviews-group d-flex">
                    <svg class="review-star" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style9 border rounded-3 mb-3 mb-md-4 mb-xxl-5">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-42-1.jpg" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                </div>
                <div class="anim_appear-bottom position-absolute w-100 text-center">
                  <button class="btn btn-round btn-hover-red border-0 text-uppercase me-2 js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                    <svg class="d-inline-block" width="14" height="14" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">Fruits</p>
                <h6 class="pc__title">
                  <a href="product1_simple.php">Organic Banana</a>
                </h6>
                <div class="product-card__review d-sm-flex align-items-center">
                  <div class="reviews-group d-flex">
                    <svg class="review-star" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4" id="products-grid-10">
          <div class="product-card-wrapper">
            <div class="product-card product-card_style10 mb-3 mb-md-4 mb-xxl-5">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-43.png" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
              ...
              <div class="pc__info position-relative d-flex flex-column align-items-center mb-3 mb-md-4 mb-xxl-5">
                <h6 class="pc__title text-uppercase fw-semi-bold">
                  <a href="product1_simple.php">Aviator Classic</a>
                </h6>
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style10 mb-3 mb-md-4 mb-xxl-5">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-44.png" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  <button class="pc__btn-wl position-absolute rounded-circle border-0 text-secondary js-add-wishlist bg-transparent" title="Add To Wishlist">
                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_heart"></use>
                    </svg>
              ...
              <div class="pc__info position-relative d-flex flex-column align-items-center mb-3 mb-md-4 mb-xxl-5">
                <h6 class="pc__title text-uppercase fw-semi-bold">
                  <a href="product1_simple.php">New Wayfarer Classic</a>
                </h6>
                <div class="product-card__price d-flex text-secondary mb-2">
                  <span class="money price">$429</span>
                </div>
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style10 mb-3 mb-md-4 mb-xxl-5">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-45.png" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  <button class="pc__btn-wl position-absolute rounded-circle border-0 text-secondary js-add-wishlist bg-transparent" title="Add To Wishlist">
                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_heart"></use>
                    </svg>
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-card_style10 mb-3 mb-md-4 mb-xxl-5">
              <div class="position-relative pb-3">
                <div class="pc__img-wrapper pc__img-wrapper_wide3">
                  <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-46.png" width="256" height="201" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                  <button class="pc__btn-wl position-absolute rounded-circle border-0 text-secondary js-add-wishlist bg-transparent" title="Add To Wishlist">
                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_heart"></use>
                    </svg>
    ...
    <div class="footer-middle container">
      <div class="row row-cols-lg-5 row-cols-2">
        ...
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          ...
          <ul class="sub-menu__list list-unstyled">
            <li class="sub-menu__item">
              <a href="about.php" class="menu-link menu-link_us-s">About Us</a>
            </li>
            <li class="sub-menu__item">
            ...
            <li class="sub-menu__item">
              <a href="blog_list1.php" class="menu-link menu-link_us-s">Blog</a>
            </li>
            <li class="sub-menu__item">
              <a href="contact.php" class="menu-link menu-link_us-s">Contact Us</a>
            </li>
          </ul>
        </div>
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          ...
          <ul class="sub-menu__list list-unstyled">
            ...
            <li class="sub-menu__item">
              <a href="shop1.php" class="menu-link menu-link_us-s">Shop All</a>
            </li>
          </ul>
        </div>
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          ...
          <ul class="sub-menu__list list-unstyled">
            ...
            <li class="sub-menu__item">
              <a href="store_location.php" class="menu-link menu-link_us-s">Find a Store</a>
            </li>
            <li class="sub-menu__item">
              <a href="#" class="menu-link menu-link_us-s">Legal & Privacy</a>
            </li>
            <li class="sub-menu__item">
              <a href="contact.php" class="menu-link menu-link_us-s">Contact</a>
            </li>
            <li class="sub-menu__item">
