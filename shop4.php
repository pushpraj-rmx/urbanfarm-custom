    ...
    <main>
      <section class="shop-main container d-flex pt-4 pt-xl-5">
        ...
        <div class="shop-list flex-grow-1">
          <div
            class="swiper-container js-swiper-slider slideshow slideshow_small"
            data-settings='{
            "autoplay": {
              "delay": 5000
            },
          ...
          >
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div
                  class="overflow-hidden position-relative h-100"
                  style="background-color: #eee"
                >
                  <div
                    class="slideshow-character position-absolute bottom-0 pos_right-center"
                  >
                    <img
                      loading="lazy"
                    ...
                    <div class="character_markup">
                      <p
                        class="font-special text-uppercase animate animate_fade animate_rtl animate_delay-10"
                      >
                        Summer
                      </p>
                    </div>
                  ...
                  <div
                    class="slideshow-text container position-absolute start-50 top-50 translate-middle p-3 p-xl-5"
                  >
                    <h6
                    ...
                    <h2
                      class="text-uppercase page-title fw-normal mb-0 animate animate_fade animate_btt animate_delay-5"
                    >
                      Summer Sale Stylish
                    </h2>
                    <h2
                      class="text-uppercase page-title fw-bold animate animate_fade animate_btt animate_delay-5"
                    >
                      Womens
                    </h2>
                    <a
                      href="#"
                      class="btn-link btn-link_lg text-uppercase fw-medium animate animate_fade animate_btt animate_delay-7"
                      >Discover More</a
                    >
                  </div>
                </div>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  >
                    ...
                    <h2
                      class="text-uppercase page-title fw-bold animate animate_fade animate_btt animate_delay-3"
                    >
                      Hello New Season
                    </h2>
                    <h6
                      class="text-uppercase mb-3 animate animate_fade animate_btt animate_delay-3"
                    >
                      Limited Time Offer - Up to 60% off & Free Shipping
                    </h6>
                    <a
                      href="#"
                      class="btn-link btn-link_lg text-uppercase fw-medium animate animate_fade animate_btt animate_delay-3"
                      >Discover More</a
                    >
                  </div>
                </div>
            ...
            <div class="p-3 p-xl-5">
              <div
                class="slideshow-pagination d-flex align-items-center position-absolute bottom-0 mb-4"
              ></div>
            </div>
          </div>
