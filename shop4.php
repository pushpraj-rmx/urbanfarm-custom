              ...
              <div class="overflow-hidden position-relative h-100" style="background-color: #eee">
                <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                  ...
                  <div class="character_markup">
                    <p class="font-special text-uppercase animate animate_fade animate_rtl animate_delay-10">
                      Summer
                    </p>
                  </div>
                </div>
                <div class="slideshow-text container position-absolute start-50 top-50 translate-middle p-3 p-xl-5">
                  ...
                  <h2 class="text-uppercase page-title fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">
                    Summer Sale Stylish
                  </h2>
                  <h2 class="text-uppercase page-title fw-bold animate animate_fade animate_btt animate_delay-5">
                    Womens
                  </h2>
            ...
            <div class="swiper-slide">
              <div class="overflow-hidden position-relative h-100" style="background-color: #eee">
                ...
                <div class="slideshow-text container position-absolute start-50 top-50 translate-middle p-3 p-xl-5">
                  ...
                  <h2 class="text-uppercase page-title fw-bold animate animate_fade animate_btt animate_delay-3">
                    Hello New Season
                  </h2>
                  <h6 class="text-uppercase mb-3 animate animate_fade animate_btt animate_delay-3">
