      ...
      <div class="row">
        <div class="col-lg-3">
          <ul class="account-nav">
            <li>
              <a href="account_dashboard.php" class="menu-link menu-link_us-s menu-link_active">Dashboard</a>
            </li>
            <li>
              <a href="account_orders.php" class="menu-link menu-link_us-s">Orders</a>
            </li>
            <li>
              <a href="account_edit_address.php" class="menu-link menu-link_us-s">Addresses</a>
            </li>
            <li>
              <a href="account_edit.php" class="menu-link menu-link_us-s">Account Details</a>
            </li>
            <li>
              <a href="account_wishlist.php" class="menu-link menu-link_us-s">Wishlist</a>
            </li>
            <li>
              <a href="login_register.php" class="menu-link menu-link_us-s">Logout</a>
            </li>
          </ul>
        </div>
        <div class="col-lg-9">
          <div class="page-content my-account__dashboard">
            <p>
              ...
              <a href="login_register.php">Log out</a>)
            </p>
            <p>
              From your account dashboard you can view your
              <a class="unerline-link" href="account_orders.php">recent orders</a>, manage your
              <a class="unerline-link" href="account_edit_address.php">shipping and billing addresses</a>, and
              <a class="unerline-link" href="account_edit.php">edit your password and account details.</a>
            </p>
          </div>
        </div>
      </div>
