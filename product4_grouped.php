    ...
    <section class="product-single container">
      <div class="row">
          ...
          <div class="product-single__media" data-media-type="vertical-thumbnail">
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="./images/products/product_0.jpg" width="104" height="104" alt="" />
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="./images/products/product_0-1.jpg" width="104" height="104" alt="" />
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="./images/products/product_0-2.jpg" width="104" height="104" alt="" />
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="./images/products/product_0-3.jpg" width="104" height="104" alt="" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__price product-single__grouped-price">
            <span class="from-price">$130</span>
            <span>-</span>
            <span class="to-price">$170</span>
          </div>
          ...
          <form name="addtocart-form" method="post">
            <div class="product-single__addtocart product-single__grouped">
              <div class="grouped-item">
                ...
                <div class="grouped-item__name">The Cotton Crew White</div>
