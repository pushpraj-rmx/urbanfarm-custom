          ...
          <div class="product-single__media" data-media-type="vertical-thumbnail">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <a data-fancybox="gallery" href="../videos/video_2.mp4" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_zoom" />
                      </svg>
                    </a>
                    <a href="#" class="product-degree" data-bs-toggle="tooltip" data-bs-placement="right" title="360 Product View"><svg class="d-block" width="40" height="30" viewBox="0 0 40 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_degree" />
                      </svg></a>
                    <button class="view-video btn-video-player" data-bs-toggle="tooltip" data-bs-placement="left" title="View Video" data-video="#video_product_1">
                    ...
                    <video id="video_product_1" class="product-video">
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img class="h-auto" loading="lazy" src="./images/products/product_0.jpg" width="104" height="104" alt="" />
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img class="h-auto" loading="lazy" src="./images/products/product_0-1.jpg" width="104" height="104" alt="" />
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img class="h-auto" loading="lazy" src="./images/products/product_0-2.jpg" width="104" height="104" alt="" />
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img class="h-auto" loading="lazy" src="./images/products/product_0-3.jpg" width="104" height="104" alt="" />
                  </div>
                </div>
              </div>
            </div>
