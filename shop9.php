  ...
  <main>
    ...
    <section class="shop-main container">
      <div class="d-flex justify-content-between mb-4 pb-md-2">
        <div class="shop-acs d-flex align-items-center flex-grow-1 pe-1">
          <fieldset class="multi-select d-none d-lg-block">
            ...
            <div class="position-relative hover-container">
              <div class="js-hover__open">
                <span class="multi-select__actor fw-medium text-uppercase js-no-update">Category</span>
              </div>
              <div class="filters-container js-hidden-content mt-2">
                <ul class="multi-select__list list-unstyled mb-0">
                  <li class="multi-select__item text-primary js-multi-select">
                    <span class="me-auto">Banking</span>
                    <span class="text-secondary">95</span>
                  </li>
                  <li class="multi-select__item text-primary js-multi-select">
                    <span class="me-auto">Digital & Creative</span>
                    <span class="text-secondary">39</span>
                  </li>
                  <li class="multi-select__item text-primary js-multi-select">
                    <span class="me-auto">Retail</span>
                    <span class="text-secondary">8</span>
                  </li>
                  <li class="multi-select__item text-primary js-multi-select">
                    <span class="me-auto">Designer</span>
                    <span class="text-secondary">5</span>
                  </li>
                  <li class="multi-select__item text-primary js-multi-select">
                    <span class="me-auto">Developer</span>
          ...
          <fieldset class="multi-select d-none d-md-block px-1">
            ...
            <div class="position-relative hover-container">
              <div class="js-hover__open">
                <span class="multi-select__actor fw-medium text-uppercase js-no-update">Size</span>
              </div>
              <div class="filters-container js-hidden-content mt-2">
                <ul class="multi-select__list list-unstyled">
                  <li class="multi-select__item text-primary js-multi-select">
                    <span class="me-auto">XS</span>
                    <span class="text-secondary">2</span>
                  </li>
                  <li class="multi-select__item text-primary js-multi-select">
                  ...
                  <li class="multi-select__item text-primary js-multi-select">
                    <span class="me-auto">XL</span>
                    <span class="text-secondary">10</span>
                  </li>
                  <li class="multi-select__item text-primary js-multi-select">
                    <span class="me-auto">XXL</span>
          ...
          <div class="position-relative hover-container d-none d-lg-block px-1">
            <div class="js-hover__open">
              <span class="multi-select__actor fw-medium text-uppercase js-no-update">Color</span>
            </div>
            <div class="filters-container js-hidden-content mt-2">
              <div class="d-flex flex-wrap">
                <a href="#" class="swatch-color m-1 js-filter" style="color: #0a2472"></a>
                <a href="#" class="swatch-color m-1 js-filter" style="color: #d7bb4f"></a>
                <a href="#" class="swatch-color m-1 js-filter" style="color: #282828"></a>
                <a href="#" class="swatch-color m-1 js-filter" style="color: #b1d6e8"></a>
                <a href="#" class="swatch-color m-1 js-filter" style="color: #9c7539"></a>
                <a href="#" class="swatch-color m-1 js-filter" style="color: #d29b48"></a>
                <a href="#" class="swatch-color m-1 js-filter" style="color: #e6ae95"></a>
                <a href="#" class="swatch-color m-1 js-filter" style="color: #d76b67"></a>
                <a href="#" class="swatch-color m-1 swatch_active js-filter" style="color: #bababa"></a>
                <a href="#" class="swatch-color m-1 js-filter" style="color: #bfdcc4"></a>
              </div>
            </div>
          </div>
          ...
          <div class="position-relative hover-container d-none d-lg-block px-1">
            <div class="js-hover__open">
              <span class="multi-select__actor fw-medium text-uppercase js-no-update">Brand</span>
            </div>
            <div class="search-field multi-select filters-container js-hidden-content mt-2">
              <select class="d-none" multiple name="total-numbers-list">
          ...
          <div class="position-relative hover-container d-none d-lg-block px-1">
            <div class="js-hover__open">
              <span class="multi-select__actor fw-medium text-uppercase js-no-update">Price</span>
            </div>
            <div class="filters-container js-hidden-content mt-2">
          ...
          <div class="shop-asc__seprator ms-1 bg-light d-none d-lg-block"></div>
        </div>

        <select class="shop-acs__select form-select fw-medium w-auto border-0 py-0 order-0 order-lg-2" aria-label="Sort Items" name="total-number">
        ...
        <div class="shop-filter d-flex align-items-center order-0 d-lg-none">
      ...
      <div class="products-grid" id="products-grid">
        <div class="products-masonry row row-cols-md-2 mb-2 mb-md-3 pb-1 pb-md-3">
          <div class="product-card-wrapper">
            <div class="product-card h-100 mb-2 pb-1 pb-md-0">
              <div class="pc__img-wrapper hover-container p-lg-0">
                <img loading="lazy" src="./images/products/product-23-1.jpg" width="690" height="714" alt="Cropped Faux leather Jacket" class="pc__img object-position-top" />
                <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                  ...
                  <div class="product-card__review d-flex flex-wrap align-items-center justify-content-center">
                  ...
                  <button class="pc__atc anim_appear-bottom btn mt-3 border-0 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                    Add To Cart
                  </button>
                </div>
              </div>
          ...
          <div class="d-flex flex-column">
            <div class="row row-cols-2 flex-grow-1 mb-lg-4">
              <div class="product-card-wrapper">
                <div class="product-card h-100 mb-2">
                  <div class="pc__img-wrapper hover-container p-lg-0">
                    <img loading="lazy" src="./images/products/product-18-1.jpg" width="330" height="347" alt="Calvin Shorts" class="pc__img object-position-top" />
                    <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                      <p class="pc__category">Dresses</p>
                      <h6 class="pc__title">
              ...
              <div class="product-card-wrapper">
                <div class="product-card h-100 mb-2">
                  <div class="pc__img-wrapper hover-container p-lg-0">
                    <img loading="lazy" src="./images/products/product_2.jpg" width="330" height="347" alt="Kirby T-Shirt" class="pc__img object-position-top" />
                    <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                      <p class="pc__category">Dresses</p>
                      <h6 class="pc__title">
            ...
            <div class="product-card-wrapper flex-grow-1 pt-1">
              <div class="product-card h-100">
                <div class="pc__img pc__img-wrapper pc-wide__img-wrapper hover-container p-lg-0">
                  <img loading="lazy" src="./images/products/product-24-1.jpg" width="690" height="339" alt="Cableknit Shawl" class="pc__img object-position-top" />
                  <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                    <p class="pc__category">Dresses</p>
                    <h6 class="pc__title">
        ...
        <div class="products-masonry row row-cols-md-2 mb-2 mb-md-3 pb-1 pb-md-3">
          <div class="mb-2 pb-1 mb-md-0 pb-md-0">
            <div class="row row-cols-2 h-100">
              <div class="d-flex flex-column">
                <div class="product-card-wrapper flex-grow-1 mb-md-4">
                  <div class="product-card h-100 mb-2">
                    <div class="pc__img-wrapper hover-container p-lg-0">
                      <img loading="lazy" src="./images/products/product-22-1.jpg" width="330" height="345" alt="Kirby T-Shirt" class="pc__img object-position-top" />
                      <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                        <p class="pc__category">Dresses</p>
                        <h6 class="pc__title">
                          <a href="product1_simple.php">Kirby T-Shirt</a>
                ...
                <div class="product-card-wrapper flex-grow-1 pt-1 pt-md-2">
                  <div class="product-card h-100">
                    <div class="pc__img-wrapper hover-container p-lg-0">
                      <img loading="lazy" src="./images/products/product_9.jpg" width="330" height="337" alt="Zessi Dresses" class="pc__img object-position-top" />
                      <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                        <p class="pc__category">Dresses</p>
                        <h6 class="pc__title">
              ...
              <div class="product-card-wrapper">
                <div class="product-card h-100 mb-2">
                  <div class="pc__img pc__img-wrapper hover-container h-100 p-0">
                    <img loading="lazy" src="./images/products/product_8.jpg" width="330" height="714" alt="Cropped Faux Leather Jacket" class="pc__img object-position-top" />
                    <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                      <p class="pc__category">Dresses</p>
                      <h6 class="pc__title">
                        <a href="product1_simple.php">Cropped Faux Leather Jacket</a>
          ...
          <div class="product-card-wrapper">
            <div class="product-card h-100">
              <div class="pc__img-wrapper hover-container p-0 h-100">
                <img loading="lazy" src="./images/products/product-25-1.jpg" width="690" height="714" alt="Shirt In Botanical Cheetah Print" class="pc__img object-position-top" />
                <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                  <p class="pc__category">Dresses</p>
                  <h6 class="pc__title">
        ...
        <div class="products-grid row row-cols-2 row-cols-md-3 row-cols-lg-4">
          <div class="product-card-wrapper">
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper hover-container">
                <img loading="lazy" src="./images/products/product_7.jpg" width="330" height="400" alt="Colorful Jacket" class="pc__img object-position-top" />
                <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                  <p class="pc__category">Dresses</p>
                  <h6 class="pc__title">
                    <a href="product1_simple.php">Cableknit Shawl</a>
                  ...
                  <div class="product-card__price d-flex">
                    <span class="money price">$89</span>
                  </div>
                  <button class="pc__atc anim_appear-bottom btn mt-3 border-0 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">
                    Add To Cart
                  </button>
          ...
          <div class="product-card-wrapper">
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper hover-container">
                <img loading="lazy" src="./images/products/product_15.jpg" width="330" height="400" alt="Shirt In Botanical Cheetah Print" class="pc__img object-position-top" />
                <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                  <p class="pc__category">Dresses</p>
                  <h6 class="pc__title">
                    <a href="product1_simple.php">Shirt In Botanical Cheetah Print</a>
          ...
          <div class="product-card-wrapper">
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper hover-container">
                <img loading="lazy" src="./images/products/product_16.jpg" width="330" height="400" alt="Cotton Jersey T-Shirt" class="pc__img object-position-top" />
                <div class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center">
                  <p class="pc__category">Dresses</p>
                  <h6 class="pc__title">
