      ...
      <section class="shop-main container">
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          <div class="shop-acs d-flex align-items-center flex-grow-1 pe-1">
            <fieldset class="multi-select d-none d-lg-block">
              ...
              <div class="position-relative hover-container">
                <div class="js-hover__open">
                  <span
                    class="multi-select__actor fw-medium text-uppercase js-no-update"
                    >Category</span
                  >
                </div>
            ...
            <div
              class="shop-asc__seprator ms-2 me-4 bg-light d-none d-lg-block"
            ></div>
            ...
            <div
              class="position-relative hover-container d-none d-lg-block px-1"
            >
              <div class="js-hover__open">
                <span
                  class="multi-select__actor fw-medium text-uppercase js-no-update"
              ...
              <div class="filters-container js-hidden-content mt-2">
                <div class="d-flex flex-wrap">
                  <a
                    href="#"
                    class="swatch-color m-1 js-filter"
                    style="color: #0a2472"
                  ></a>
                  <a
                    href="#"
                  ...
                  <a
                    href="#"
                    class="swatch-color m-1 swatch_active js-filter"
                    style="color: #bababa"
                  ></a>
                  <a
                    href="#"
            ...
            >
              ...
              <div
                class="search-field multi-select filters-container js-hidden-content mt-2"
              >
                <select class="d-none" multiple name="total-numbers-list">
            ...
            <div
              class="shop-asc__seprator ms-1 bg-light d-none d-lg-block"
            ></div>
          </div>

          <select
            class="shop-acs__select form-select fw-medium w-auto border-0 py-0 order-0 order-lg-2"
        ...
        <div class="products-grid" id="products-grid">
          <div
            class="products-masonry row row-cols-md-2 mb-2 mb-md-3 pb-1 pb-md-3"
          >
            <div class="product-card-wrapper">
              <div class="product-card h-100 mb-2 pb-1 pb-md-0">
                <div class="pc__img-wrapper hover-container p-lg-0">
                  <img
                    loading="lazy"
                    src="./images/products/product-23-1.jpg"
                    width="690"
                    height="714"
                  ...
                  />
                  <div
                    class="pc__info hover__content text-center top-0 left-0 w-100 d-flex flex-column justify-content-center align-items-center"
                  >
                    ...
                    <div
                      class="product-card__price d-flex justify-content-center"
                    >
                      <span class="money price">$29</span>
                    </div>
                    <div
                      class="product-card__review d-flex flex-wrap align-items-center justify-content-center"
                    >
                    ...
                    <button
                      class="pc__atc anim_appear-bottom btn mt-3 border-0 text-uppercase fw-medium js-add-cart js-open-aside"
                      data-aside="cartDrawer"
                      title="Add To Cart"
                    >
                      Add To Cart
            ...
            <div class="d-flex flex-column">
              ...
              <div class="product-card-wrapper flex-grow-1 pt-1">
                <div class="product-card h-100">
                  <div
                    class="pc__img pc__img-wrapper pc-wide__img-wrapper hover-container p-lg-0"
                  >
                    <img
                      loading="lazy"
                      src="./images/products/product-24-1.jpg"
                      width="690"
                      height="339"
                      alt="Cableknit Shawl"
                      class="pc__img object-position-top"
            ...
            <div class="mb-2 pb-1 mb-md-0 pb-md-0">
              <div class="row row-cols-2 h-100">
                ...
                <div class="product-card-wrapper">
                  <div class="product-card h-100 mb-2">
                    <div
                      class="pc__img pc__img-wrapper hover-container h-100 p-0"
                    >
                      <img
                        loading="lazy"
        ...
        <div class="text-center">
          <a class="btn btn-primary text-uppercase fw-medium fs-base" href="#"
            >Show More</a
          >
        </div>
      </section>
