...
<body>
  ...
  <header id="header" class="header header_sticky header_dark">
    <div class="container">
      <div class="header-desk header-desk_type_1">
        <div class="logo">
          <a href="../index.php">
            <img src="./images/logo-white.png" alt="Uomo" class="logo__image d-block" />
          </a>
        </div>
  ...
  <main>
    <section class="product-single product-single__type-3">
      <div class="product-single__top-background">
        <div class="container">
          <div class="row">
                  ...
                  <div class="swiper-container">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="./images/products/product_0-4.png" width="724" height="859" alt="" />
                      </div>
                      <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="./images/products/product_0-4.png" width="724" height="859" alt="" />
                      </div>
            ...
            <div class="col-lg-5 pb-4 d-flex flex-column">
              ...
              <form name="addtocart-form" method="post">
                <div class="product-single__swatches">
                  ...
                  <div class="product-swatch color-swatches">
                    <label>Color</label>
                    <div class="swatch-list">
                      <input type="radio" name="color" id="swatch-11" checked />
                      <label class="swatch swatch-color js-swatch" for="swatch-11" aria-label="Grey" data-bs-toggle="tooltip" data-bs-placement="top" title="Grey" style="color: #767676"></label>
                      ...
                      <label class="swatch swatch-color js-swatch" for="swatch-13" aria-label="White" data-bs-toggle="tooltip" data-bs-placement="top" title="White" style="color: #e4e4e4"></label>
                    </div>
                  </div>
                </div>
              ...
              <div class="product-single__addtolinks">
                ...
                <share-button class="share-button">
                  <button class="menu-link menu-link_us-s to-share border-0 bg-transparent d-flex align-items-center color-white">
