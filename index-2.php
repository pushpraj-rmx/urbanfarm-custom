    ...
    <header id="header" class="header header-fullwidth header-transparent-bg">
      <div class="header-top d-flex bg-black color-white align-items-center">
        <ul class="list-unstyled d-flex flex-1 gap-3 m-0">
          <li>
            <a href="#" class="menu-link menu-link_us-s color-white"
              >Shipping</a
            >
          </li>
          <li>
        ...
        <div class="heeader-top__right flex-1 d-flex gap-1 justify-content-end">
          ...
          <select
            class="form-select form-select-sm bg-transparent color-white"
            name="store-language"
          >
                  ...
                  <div class="mega-menu__media col">
                    <div class="position-relative">
                      ...
                      >
                        ...
                        <a href="#" class="btn-link default-underline fw-medium"
                          >SHOP NOW</a
                        >
                      </div>
                    </div>
    ...
    <main>
      ...
      >
          ...
          <div class="swiper-slide">
            <div class="overflow-hidden position-relative h-100">
              <div class="slideshow-bg">
                <img
                  loading="lazy"
                  src="./images/home/demo2/slider1.jpg"
                  width="1903"
                  height="896"
                  alt="Pattern"
          ...
          <div class="swiper-slide">
            <div class="overflow-hidden position-relative h-100">
              <div class="slideshow-bg">
                <img
                  loading="lazy"
                  src="./images/home/demo2/slider2.jpg"
                  width="1903"
                  height="896"
                  alt="Pattern"
                  class="slideshow-bg__img object-fit-cover"
              ...
              >
                <h6
                  class="text_dash text-uppercase text-shadow-white fs-base fw-medium animate animate_fade animate_btt animate_delay-3"
                >
                  Summer 2023
                </h6>
                <h2
          ...
          <div class="swiper-slide">
            <div class="overflow-hidden position-relative h-100">
              <div class="slideshow-bg">
                <img
                  loading="lazy"
                  src="./images/home/demo2/slider3.jpg"
                  width="1903"
                  height="896"
                  alt="Pattern"
                  class="slideshow-bg__img object-fit-cover"
        ...
        <a
          ...
          class="slideshow-scroll d-none d-xxl-block position-absolute end-0 bottom-3 text_dash text-uppercase fw-medium"
          >Scroll</a
        >
      </section>
      ...
      <section class="products-carousel container">
        <h2
          class="section-title text-uppercase fw-bold text-center mb-1 mb-md-3 pb-xl-2 mb-xl-4"
        >
          Best Selling
        </h2>

        <ul
          class="nav nav-tabs mb-3 mb-xl-5 text-uppercase justify-content-center"
          id="collections-tab"
          role="tablist"
        >
                  ...
                  <div class="swiper-slide product-card">
                    <div class="pc__img-wrapper">
                      <a href="product1_simple.html">
                        ...
                        <img
                          loading="lazy"
                          src="./images/home/demo2/product-0-2.jpg"
                          width="330"
                          height="400"
                          alt="Cropped Faux leather Jacket"
                  ...
                  <div class="swiper-slide product-card">
                    <div class="pc__img-wrapper">
                      <a href="product1_simple.html">
                        ...
                        <img
                          loading="lazy"
                          src="./images/home/demo2/product-1-2.jpg"
                          width="330"
                          height="400"
                          alt="Cropped Faux leather Jacket"
                          class="pc__img pc__img-second"
                  ...
                  <div class="swiper-slide product-card">
                    <div class="pc__img-wrapper">
                      <a href="product1_simple.html">
                        ...
                        <img
                          loading="lazy"
                          src="./images/home/demo2/product-2-2.jpg"
                          width="330"
                          height="400"
                          alt="Cropped Faux leather Jacket"
                          class="pc__img pc__img-second"
                  ...
                  <div class="swiper-slide product-card">
                    <div class="pc__img-wrapper">
                      <a href="product1_simple.html">
                        ...
                        <img
                          loading="lazy"
                          src="./images/home/demo2/product-3-2.jpg"
                          width="330"
                          height="400"
                          alt="Cropped Faux leather Jacket"
                          class="pc__img pc__img-second"
      ...
      <section class="category-carousel container">
        <h2
          class="section-title text-uppercase fw-bold text-center mb-3 pb-xl-2 mb-xl-4"
        >
          Shop by category
        </h2>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img
                  ...
                  src="./images/home/demo2/category1.jpg"
                  width="258"
                  height="278"
                  alt=""
                />
                <div class="text-center">
                  <a href="#" class="menu-link menu-link_us-s text-uppercase"
                    >Accessories</a
                  >
              ...
              <div class="swiper-slide">
                <img
                  loading="lazy"
                  class="w-100 h-auto mb-3"
                  src="./images/home/demo2/category2.jpg"
                  width="258"
                  height="278"
                  alt=""
                />
              ...
              <div class="swiper-slide">
                <img
                  loading="lazy"
                  class="w-100 h-auto mb-3"
                  src="./images/home/demo2/category3.jpg"
                  width="258"
                  height="278"
                  alt=""
                />
              ...
              <div class="swiper-slide">
                <img
                  loading="lazy"
                  class="w-100 h-auto mb-3"
                  src="./images/home/demo2/category4.jpg"
                  width="258"
                  height="278"
                  alt=""
                />
              ...
              <div class="swiper-slide">
                <img
                  loading="lazy"
                  class="w-100 h-auto mb-3"
                  src="./images/home/demo2/category5.jpg"
                  width="258"
                  height="278"
                  alt=""
                />
      ...
      <section class="image-banner">
        ...
        <div class="image-banner__content container py-3">
          ...
          <button
            class="btn btn-outline-primary border-0 fs-base text-uppercase fw-medium btn-55"
          >
      ...
      <section class="products-carousel container">
        <h2
          class="section-title text-uppercase fw-bold text-center mb-4 pb-xl-2 mb-xl-4"
        >
          Latest Products
        </h2>
              ...
              <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                  <a href="product1_simple.html">
                    ...
                    <img
                      loading="lazy"
                      src="./images/home/demo2/product-4-2.jpg"
                      width="330"
                      height="400"
                      alt="Cropped Faux leather Jacket"
                      class="pc__img pc__img-second"
              ...
              <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                  <a href="product1_simple.html">
                    ...
                    <img
                      loading="lazy"
                      src="./images/home/demo2/product-5-2.jpg"
                      width="330"
                      height="400"
                      alt="Cropped Faux leather Jacket"
                      class="pc__img pc__img-second"
              ...
              <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                  <a href="product1_simple.html">
                    ...
                    <img
                      loading="lazy"
                      src="./images/home/demo2/product-6-2.jpg"
                      width="330"
                      height="400"
                      alt="Cropped Faux leather Jacket"
                      class="pc__img pc__img-second"
              ...
              <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                  <a href="product1_simple.html">
                    ...
                    <img
                      loading="lazy"
                      src="./images/home/demo2/product-7-2.jpg"
                      width="330"
                      height="400"
                      alt="Cropped Faux leather Jacket"
                      class="pc__img pc__img-second"
      ...
      <section class="blog-carousel container">
        ...
        <div class="position-relative">
              ...
              <div class="swiper-slide blog-grid__item mb-4">
                <div class="blog-grid__item-image">
                  <img
                    loading="lazy"
                    class="h-auto"
                    src="./images/home/demo2/post1.jpg"
                    width="450"
                    height="300"
                    alt=""
                  />
              ...
              <div class="swiper-slide blog-grid__item mb-4">
                <div class="blog-grid__item-image">
                  <img
                    loading="lazy"
                    class="h-auto"
                    src="./images/home/demo2/post2.jpg"
                    width="450"
                    height="300"
                    alt=""
                  />
              ...
              <div class="swiper-slide blog-grid__item mb-4">
                <div class="blog-grid__item-image">
                  <img
                    loading="lazy"
                    class="h-auto"
                    src="./images/home/demo2/post3.jpg"
                    width="450"
                    height="300"
                    alt=""
                  />
          ...
          <div
            class="blog-pagination type2 mt-1 mt-md-4 d-flex align-items-center justify-content-center"
          ></div>
        </div>
      </section>
