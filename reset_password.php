...
<body>
  ...
  <main>
    ...
    <section class="login-register container">
      <h2 class="section-title text-center fs-3 mb-xl-5">
        Reset Your Password
      </h2>
      ...
      <div class="reset-form">
        <form name="reset-form" class="needs-validation" novalidate>
          ...
          <div class="customer-option mt-4 text-center">
            ...
            <a href="login_register.php" class="btn-text js-show-register">Login</a>
          </div>
        </form>
      </div>
    </section>
    ...
    <div class="customer-forms__wrapper d-flex position-relative">
      <div class="customer__login">
        ...
        <form action="https://uomo-html.flexkitux.com/Demo2/" method="POST" class="aside-content">
          <div class="form-floating mb-3">
            <input name="email" type="email" class="form-control form-control_gray" id="customerNameEmailInput1" placeholder="name@example.com" />
            <label for="customerNameEmailInput1">Username or email address *</label>
          </div>
