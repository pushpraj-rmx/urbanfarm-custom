...
<body>
  ...
  <header id="header" class="header header_sticky header_transparent">
    <div class="container">
  ...
  <main>
    <section class="product-single product-single__type-4 container">
      <div class="row">
        <div class="col-lg-7">
          <div class="product-single__media" data-media-type="scroll-snap">
            <div class="product-single__image">
              <div id="product_media_1" class="product-single__image-item">
                <img loading="lazy" src="./images/products/product_0-5.jpg" width="798" height="845" alt="" />
              </div>
              <div id="product_media_2" class="product-single__image-item">
                <img loading="lazy" src="./images/products/product_0-6.jpg" width="798" height="845" alt="" />
              </div>
              <div id="product_media_3" class="product-single__image-item">
                <img loading="lazy" src="./images/products/product_0-7.jpg" width="798" height="845" alt="" />
              </div>
              <div id="product_media_4" class="product-single__image-item">
                <img loading="lazy" src="./images/products/product_0-8.jpg" width="798" height="845" alt="" />
              </div>
            </div>
          </div>
        </div>
