  ...
  <main>
    ...
    <section class="blog-page blog-single container">
      ...
      <div class="blog-single__item-content">
        <p>
          <img loading="lazy" class="w-100 h-auto d-block" src="./images/blog/blog-14.jpg" width="1410" height="550" alt="" />
        </p>
        <div class="mw-930">
          <p>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <ul class="list text-list list_dot_darkgray">
                <li class="list-item text-list__item">
        ...
        <div class="container mw-1170">
          <div class="row">
            <div class="col-md-6">
              <p>
                <img loading="lazy" class="w-100 h-auto d-block" src="./images/blog/blog-15.jpg" width="570" height="697" alt="" />
              </p>
            </div>
            <div class="col-md-6">
              <p>
                <img loading="lazy" class="w-100 h-auto d-block" src="./images/blog/blog-16.jpg" width="570" height="697" alt="" />
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="blog-single__item-share mw-930">
        <a href="http://www.facebook.com/sharer.php?u=https://uomo-crystal.myshopify.com/blogs/news/go-to-wellness-tips-for-mental-health" class="btn btn-share btn-facebook">
          <svg class="svg-icon svg-icon_facebook" width="9" height="15" fill="#fff" viewBox="0 0 9 15" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="http://twitter.com/share?text=Go-to%20Wellness%20Tips%20for%20Mental%20Health&amp;url=https://uomo-crystal.myshopify.com/blogs/news/go-to-wellness-tips-for-mental-health" class="btn btn-share btn-twitter">
          <svg class="svg-icon svg-icon_twitter" width="14" height="13" fill="#fff" viewBox="0 0 14 13" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="http://pinterest.com/pin/create/button/?url=https://uomo-crystal.myshopify.com/blogs/news/go-to-wellness-tips-for-mental-health&amp;media=//uomo-crystal.myshopify.com/cdn/shop/articles/blog6.jpg?crop=center&amp;height=1024&amp;v=1650609391&amp;width=1024&amp;description=Go-to%20Wellness%20Tips%20for%20Mental%20Health" class="btn btn-share btn-pinterest">
          <svg class="svg-icon svg-icon_pinterest" width="14" height="15" fill="#fff" viewBox="0 0 14 15" xmlns="http://www.w3.org/2000/svg">
        ...
        <share-button class="share-button">
          <button class="btn btn-share btn-more">+</button>
          ...
          <div class="product-single__detail">
            ...
            <div class="product-single__addtolinks">
              ...
              <share-button class="share-button">
                ...
                <details id="Details-share-template__main_2" class="m-1 xl:m-1.5" hidden="">
                  <summary class="btn-solid m-1 xl:m-1.5 pt-3.5 pb-3 px-5">
                    +
                  </summary>
                  <div id="Article-share-template__main_2" class="share-button__fallback flex items-center absolute top-full left-0 w-full px-2 py-4 bg-container shadow-theme border-t z-10">
                    <div class="field grow mr-4">
                      <label class="field__label sr-only" for="url">Link</label>
                      <input type="text" class="field__input w-full" id="url_2" value="https://uomo-crystal.myshopify.com/blogs/news/go-to-wellness-tips-for-mental-health" placeholder="Link" onclick="this.select();" readonly="" />
                    </div>
                    <button class="share-button__copy no-js-hidden">
                      <svg class="icon icon-clipboard inline-block mr-1" width="11" height="13" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" viewBox="0 0 11 13">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M2 1a1 1 0 011-1h7a1 1 0 011 1v9a1 1 0 01-1 1V1H2zM1 2a1 1 0 00-1 1v9a1 1 0 001 1h7a1 1 0 001-1V3a1 1 0 00-1-1H1zm0 10V3h7v9H1z" fill="currentColor"></path>
