                ...
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-17-1.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-17-2.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-18-1.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product_15.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-19-1.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-19-2.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-19-3.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-20-1.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-20-2.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-21-1.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-21-2.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-22-1.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-22-2.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="product1_simple.php"><img loading="lazy" src="./images/products/product-22-3.jpg" width="510" height="618" alt="Cropped Faux leather Jacket" class="pc__img" /></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_prev_sm" />
