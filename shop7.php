      ...
      <section class="full-width_padding">
        <div class="full-width_border border-2" style="border-color: #eeeeee">
          <div class="shop-banner position-relative">
            ...
            >
              <h2
                class="h1 stroke-text smooth-16 text-uppercase fw-bold mb-3 mb-xl-4 mb-xl-5"
              >
                WOMEN
              </h2>
      ...
      <section class="shop-main container pt-4 pt-xl-5">
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          >
            ...
            <div
              class="shop-asc__seprator mx-3 bg-light d-none d-lg-block"
            ></div>
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="product1_simple.php"
                        ><img
                          loading="lazy"
                          src="./images/products/product-21-1.jpg"
                          width="450"
                          height="545"
                          alt="Cropped Faux leather Jacket"
                          class="pc__img"
                    ...
                    <div class="swiper-slide">
                      <a href="product1_simple.php"
                        ><img
                          loading="lazy"
                          src="./images/products/product-21-2.jpg"
                          width="450"
                          height="545"
                          alt="Cropped Faux leather Jacket"
                          class="pc__img"
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <a href="product1_simple.php"
                        ><img
                          loading="lazy"
                          src="./images/products/product-22-3.jpg"
                          width="450"
                          height="545"
                          alt="Cropped Faux leather Jacket"
                          class="pc__img"
