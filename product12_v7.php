<!-- head: execpt ->  index, shop -->
  ...
  <body>
              ...
              <div class="product-single__image">
                <div class="product-single__image-item">
                  <img
                    loading="lazy"
                    class="h-auto"
                    src="./images/products/product_0-9.jpg"
                    width="798"
                    height="740"
                    alt=""
                  />
                ...
                <div class="product-single__image-item">
                  <img
                    loading="lazy"
                    class="h-auto"
                    src="./images/products/product_0-10.jpg"
                    width="394"
                    height="365"
                    alt=""
                  />
                ...
                <div class="product-single__image-item">
                  <img
                    loading="lazy"
                    class="h-auto"
                    src="./images/products/product_0-11.jpg"
                    width="394"
                    height="365"
                    alt=""
                  />
                ...
                <div class="product-single__image-item">
                  <img
                    loading="lazy"
                    class="h-auto"
                    src="./images/products/product_0-12.jpg"
                    width="394"
                    height="365"
                    alt=""
                  />
                ...
                <div class="product-single__image-item">
                  <img
                    loading="lazy"
                    class="h-auto"
                    src="./images/products/product_0-13.jpg"
                    width="394"
                    height="365"
                    alt=""
                  />
          ...
          <div class="col-lg-5">
            <div class="sticky-content">
              ...
              <div class="product-single__details">
                ...
                >
                <a href="#" class="js-open-aside" data-aside="productReviews"
                  >Reviews (3)</a
                >
              </div>
            </div>
              ...
              >
                ...
                <svg class="accordion-button__icon" viewBox="0 0 14 14">
                  <g aria-hidden="true" stroke="none" fill-rule="evenodd">
                    <path
                      class="svg-path-vertical"
                      d="M14,6 L14,8 L0,8 L0,6 L14,6"
                    ></path>
                    <path
                      class="svg-path-horizontal"
                      d="M14,6 L14,8 L0,8 L0,6 L14,6"
                    ></path>
                  </g>
                </svg>
    ...
    <div
      class="aside aside_right overflow-hidden product-single__aside"
