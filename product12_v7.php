...
<body>
          ...
          <div class="product-single__media" data-media-type="grid-image">
            <div class="product-single__image">
              <div class="product-single__image-item">
                <img loading="lazy" class="h-auto" src="./images/products/product_0-9.jpg" width="798" height="740" alt="" />
              </div>
              <div class="product-single__image-item">
                <img loading="lazy" class="h-auto" src="./images/products/product_0-10.jpg" width="394" height="365" alt="" />
              </div>
              <div class="product-single__image-item">
                <img loading="lazy" class="h-auto" src="./images/products/product_0-11.jpg" width="394" height="365" alt="" />
              </div>
              <div class="product-single__image-item">
                <img loading="lazy" class="h-auto" src="./images/products/product_0-12.jpg" width="394" height="365" alt="" />
              </div>
              <div class="product-single__image-item">
                <img loading="lazy" class="h-auto" src="./images/products/product_0-13.jpg" width="394" height="365" alt="" />
              </div>
            </div>
          </div>
          ...
          <div class="sticky-content">
            ...
            <div class="d-flex justify-content-between mb-4 pb-md-2">
              ...
              <div class="product-single__prev-next d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                <a href="#" class="text-uppercase fw-medium"><svg width="25" height="25" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_prev_md" />
                  </svg><span class="menu-link menu-link_us-s">Prev</span></a>
                <a href="#" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Next</span><svg width="25" height="25" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="modal-body">
          <div class="delivery-modal__wrapper">
            ...
            <p>
              ...
              Ireland and Highlands).<br />Orders placed after 6pm (after 1pm
              on Sunday) or for Northern Ireland and Highlands will be
            ...
            <p>
              Place your order before 13:00 to get it today!.<br />If you
              order later on, you’ll receive it the next day and if you order
              on Sunday, you’ll receive it the next working day.
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="aside aside_right overflow-hidden product-single__aside" id="productDescription">
    <div class="aside-header d-flex align-items-center">
      <h3 class="text-uppercase fs-6 mb-0">DESCRIPTION</h3>
      <button class="btn-close-lg js-close-aside btn-close-aside ms-auto"></button>
    </div>
  ...
  <div class="aside aside_right overflow-hidden product-single__aside" id="productAdditionalInformation">
    <div class="aside-header d-flex align-items-center">
      <h3 class="text-uppercase fs-6 mb-0">ADDITIONAL INFORMATION</h3>
      <button class="btn-close-lg js-close-aside btn-close-aside ms-auto"></button>
    </div>
  ...
  <div class="aside aside_right overflow-hidden product-single__aside" id="productReviews">
    <div class="aside-header d-flex align-items-center">
      <h3 class="text-uppercase fs-6 mb-0">REVIEWS (3)</h3>
      <button class="btn-close-lg js-close-aside btn-close-aside ms-auto"></button>
    </div>
